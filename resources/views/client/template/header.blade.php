                        ...
                        <div class="horizontal-menu main-menu-area d-none d-lg-block">
                            <nav>
                                <ul>
                                    ...
                                    <li class="mega_parent"><a href="shop.html">Page <i class="icon-arrow-down"></i></a>
                                        <ul class="mega-menu">
                                            <li><a href="#">Column One</a>
                                                <ul>
                                                    ...
                                                    <li class="menu-image"><a href="shop.html"><img src="{{asset('template_client/img/banner/menu-1.jpg')}}" alt=""></a></li>
                                                </ul>
                                            </li>
                                            <li><a href="#">Column Two</a>
                                                <ul>
                                                    ...
                                                    <li class="menu-image"><a href="shop.html"><img src="{{asset('template_client/img/banner/menu-2.jpg')}}" alt=""></a></li>
                                                </ul>
                                            </li>
                                            <li><a href="#">Column Three</a>
                                                <ul>
                                                    ...
                                                    <li class="menu-image"><a href="shop.html"><img src="{{asset('template_client/img/banner/menu-3.jpg')}}" alt=""></a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </li>
