...
<head>
	    ...
	    <link rel="shortcut icon" type="image/x-icon" href="{{asset('template_client/img/favicon.ico')}}">
		<!-- All CSS Hear -->
                                    ...
                                    <div class="col-lg-9">
                                        <div class="slider-text-info style-1 slider-text-animation">
                                            ...
                                            <div class="slider-1-des">
                                                <p>Mens Spring Fashion Scarves Infinity Eternity Cowl Neck Scarves Men Fashion Scarf Men.</p>
                                            </div>
                                    ...
                                    <div class="single-product-tab">
                                        <div class="zoomWrapper">
                                            <div id="img-1" class="zoomWrapper single-zoom">
                                                <a href="#">
                                                    <img id="zoom1" src="{{asset('template_client/img/product/1.jpg')}}" data-zoom-image="img/product/1.jpg" alt="big-1">
                                                </a>
                                            </div>
