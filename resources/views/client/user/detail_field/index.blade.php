            ...
            <div class="row">
                <div class="col-lg-3 order-2 order-lg-1">
                    ...
                    <div class="filter-wrapper pt-100">
                        ...
                        <div class="filter-wrap mb-30">
                            ...
                            @foreach($list_field as $key)
                                    <li><a href="{{ route('detail.field', ['id' => $key->lv_id]) }}">{{ $key->lv_ten }}</a></li>
                            @endforeach
                        </div>
                        <!-- filter-wrap end -->
                        <!-- filter-wrap start -->
                        <div class="filter-wrap">
                            <div class="single-banner-image">
                                <a href="#"><img alt="" src="{{ asset('template_client/img/banner/4.jpg') }}"></a>
                            </div>
                        </div>
                        <!-- filter-wrap end -->
                    </div>
                ...
                <div class="col-lg-9 order-1 order-lg-2">
                    <div class="shop-top-bar pt-100">
                        @if (count($pro_field) == 0)
                            <span style="width: 100%" class="alert alert-warning">Rất tiếc, thể loại bạn đang tìm hiện không có sản phẩm !!!</span>
                        @else
                        <div class="shop-bar-inner">
                            ...
                            <div class="toolbar-amount">
                                <span>Có {{ count($pro_field) }} sản phẩm ở trang hiện tại trên tổng số {!! $pro_field->lastPage() !!} trang</span>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <ul class="pagination-box">
                                            @if($pro_field->currentPage() != 1)
                                            <li>
                                                <a class="Pre" href="{!! str_replace('/?','?',$pro_field->url($pro_field->currentPage() - 1)) !!}">|< </a>
                                            </li>
                                            @endif
                                            @for ($i = 1; $i <= $pro_field->lastPage(); $i = $i + 1)
                                            <li>
                                                <a class="{!! ($pro_field->currentPage() == $i) ? 'active' : ' ' !!}" href="{!! str_replace('/?','?',$pro_field->url($i)) !!}">{!! $i !!}</a>
                                            </li>
                                            @endfor
                                            @if($pro_field->currentPage() != $pro_field->lastPage())
                                            <li>
                                                <a class="Next" href="{!! str_replace('/?','?',$pro_field->url($pro_field->currentPage() + 1)) !!}"> >|</a>
                                            </li>
                                            @endif
                                        </ul>
                                    </div>
